...
function Products(props) {
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-10 md:grid-cols-1 sm:grid-cols-1 my-5">
        <div className="flex relative col-span-6 justify-self-end"></div>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start mb-3">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <h3 className="text-lg leading-6 font-bold text-gray-900">{isEditProduct ? "Edit Product" : "Add Product"}</h3>
                  </div>
                </div>
              </div>
              <AddOrEditProduct
