...
function CustomerIndex(props) {
  ...
  return (
    <div>
      {products &&
        <>
          <div className={`relative lg:grid lg:grid-cols-4 gap-1 md:grid md:grid-cols-2 sm:grid sm:grid-cols-1 bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 w-full h-56 shadow-lg`}>
            {categoryNames &&
          ...
          {categoryNames &&
            categoryNames.map((c, index) => (
              <div key={index}>
                ...
                <div className={`relative lg:grid lg:grid-cols-4 gap-1 md:grid md:grid-cols-2 sm:grid sm:grid-cols-1 bg-gradient-to-l from-green-400 to-blue-500 w-full h-96 shadow-xl`}>
